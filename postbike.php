...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    ?>
                                    ...
                                    <label for="leatherseats"> Leather Seats </label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="col-sm-8 col-sm-offset-2 mb-50">
                                                                                        <?php if ($_SESSION['login']) { ?>
                                                                                                            <button class="btn btn-primary" name="submit" type="submit">Post Bike </button>
                                                                                        <?php } else { ?>
                                                                                                            <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Post</a>
                                                                                        <?php } ?>
                                                                                    </div>
                                                                                </div>
                    ...
                    <?php include('includes/login.php'); ?>
                                            ...
                                            $(document).ready(function() {
                                                $('#bikePostForm').submit(function(event) {
                                                    event.preventDefault(); // Prevent default form submission

                                                    // Check if user is logged in
                                                    $.ajax({
                                                        url: 'check_login.php', // PHP file to check login status
                                                        type: 'GET',
                                                        success: function(response) {
                                                            if (response === 'loggedIn') {
                                                                // User is logged in, submit the bike post form
                                                                $('#bikePostForm').unbind('submit').submit();
                                                            } else {
